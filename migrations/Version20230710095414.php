 ...
 */
final class Version20230710095414 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task ADD created_at DATETIME NOT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task DROP created_at, CHANGE id id VARCHAR(255) NOT NULL');
    }
}
